...
-- 으로 표시하도록 핚다.  
SELECT DEPARTMENT_NAME "학과 명", FK_DEPARTMENT_CATEGORY 계열
FROM TB_DEPARTMENT;
...
SELECT DISTINCT DEPARTMENT_NAME, FK_DEPARTMENT_CATEGORY
FROM TB_STUDENT
...
SELECT * FROM TB_DEPARTMENT;
SELECT DISTINCT  FK_DEPARTMENT_CATEGORY
FROM TB_dEPARTMENT;

-- 10. 02 학번 전주 거주자들의 모임을 만들려고 핚다. 휴학핚 사람들은 제외핚 재학중인 
-- 학생들의 학번, 이름, 주민번호를 출력하는 구문을 작성하시오.
SELECT * FROM TB_STUDENT;
SELECT STUDENT_NO 학번, STUDENT_NAME 이름, STUDENT_SSN 주민번호, STUDENT_ADDRESS 주소
FROM TB_STUDENT
